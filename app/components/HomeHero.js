    ...
    >
      ...
      >
        <div style={heroImage ? {
          ...
          >
            Your Home in Uptown Awaits
          </h1>
          {!heroImage && (
            <p className="hero-subtitle">
              Comfortable studio, one-bedroom, and two-bedroom apartments at Argyle Place &mdash;
              steps from the lakefront in Chicago&rsquo;s vibrant Uptown neighborhood.
            </p>
          )}

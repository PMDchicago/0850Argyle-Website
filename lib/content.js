...
export function getSiteConfig() {
  ...
  return {
    site_title: site.site_title || 'Argyle Place',
    phone_number: site.phone_number || '(773) 275-0850',
    address: site.address || {
      street: '840–850 W. Argyle St.',
      city: 'Chicago',
      state: 'IL',
      zip: '60640'
    },
    ...
    colors: site.colors || { primary: '#1f3a5f', secondary: '#c5a065' },
    nav: site.nav || [],
    footer: site.footer || {}
  };
}
